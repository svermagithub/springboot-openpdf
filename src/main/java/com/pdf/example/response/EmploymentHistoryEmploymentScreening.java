...
public class EmploymentHistoryEmploymentScreening extends EmploymentHistory implements EmploymentMapper {
	...
	public void setEmploymentInformation(List<EmploymentInformation> employmentInformation) {
